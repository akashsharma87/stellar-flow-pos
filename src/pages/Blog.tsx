    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-background-gradient">
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
                ...
                >
                  <Link to={`/blog/${post._id}`} className="cursor-pointer">
                    <div className="glass-card rounded-2xl overflow-hidden h-full group-hover:glow-accent transition-all duration-300">
                      ...
                      <div className={`h-48 bg-gradient-to-br ${post.gradient || "from-primary/20 to-accent/20"} relative overflow-hidden`}>
          ...
          <motion.div
            className="glass-card rounded-2xl p-8 max-w-3xl mx-auto text-center"
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            <div className="inline-flex items-center gap-2 glass-card px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm text-secondary">Stay Updated</span>
            </div>
            
            <h2 className="text-3xl font-bold mb-4">
              Subscribe to Our <span className="gradient-text-primary">Newsletter</span>
            </h2>
            
            <p className="text-secondary mb-6 max-w-xl mx-auto">
              Get the latest industry insights, product updates, and expert tips delivered straight to your inbox.
            </p>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <Input 
                ...
                required
              />
              <Button type="submit" className="whitespace-nowrap" disabled={isSubscribing}>
